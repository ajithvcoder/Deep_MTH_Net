...
if __name__ == "__main__":
    ...
    model.fit_generator(generator=train_gen, validation_data=valid_gen, use_multiprocessing=True, epochs=nb_epoch,
                        initial_epoch=last_executed_epoch, verbose=1, workers=6, callbacks=callbacks)
    ...
    # last_executed_epoch = 0
    # nb_epoch = 150
    #model.load_weights("/content/gdrive/My Drive/dmth_30_9_results/weights/Assignment5_RESNET__90.hdf5")
