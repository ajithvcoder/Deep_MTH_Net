...
if __name__ == "__main__":
    ...
    model.load_weights("dmth_results/bestvalweights/resnet-epochs:008-validation.hdf5")
    ...
    for i in range(n_filters):
        ...
        for j in range(3):
            ...
            ix += 1
    pyplot.savefig('filter.png', bbox_inches='tight')
    #-------------------------------------------------
    ...
    for _ in range(square):
        for _ in range(square):
            ...
            ix += 1
    pyplot.savefig('visuval_pedestrain.png', bbox_inches='tight')
    #-----------------------------------------------------------------
